...
> > | [`cargo-quality`](https://github.com/RAprogramm/cargo-quality) | Code quality with hardcoded standards | Zero-config quality enforcement |
> > | [`rust-diff-analyzer`](https://github.com/RAprogramm/rust-prod-diff-checker) | Semantic PR size analysis | Enforce reviewable PR sizes |
> > | [`sql-query-analyzer`](https://github.com/RAprogramm/sql-query-analyzer) | SQL static analysis + LLM optimization | Projects with SQL queries |
> >
> > <details>
...
> >
> > <details>
> > <summary><strong>rust-diff-analyzer: Semantic PR Analysis</strong></summary>
> >
> > **The Problem:**
